...
<main>
    <div class="header-container"   >
        <p class="input__error-message">Пользователь с указанными данными зарегистрирован.</p>
        <p class="input__error-message">Пароль должен содержать от 4 до 30 символов, хотя бы один символ верхнего и нижнего регистра цифры и спецсимволы.</p>
    </div>
